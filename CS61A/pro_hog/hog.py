...
def play(strategy0, strategy1, update,
    ...
    while (score0<goal and score1<goal):
        #update points based on current player
        if (who == 0):
...
def max_scoring_num_rolls(dice=six_sided, samples_count=1000):
    ...
    while rolls <= 10:
        ...
        averaged_dice_score = averaged_dice(rolls, dice)
        print("DEBUG:", rolls, averaged_dice_score)
        if averaged_dice_score > best_score:
            best = rolls
            best_score = averaged_dice_score
        rolls += 1
    return best
    # END PROBLEM 9
...
def sus_strategy(score, opponent_score, threshold=11, num_rolls=6):
    ...
    # BEGIN PROBLEM 11
    new_boar_brawl_points = boar_brawl(score, opponent_score)
    new_points = sus_points(score + new_boar_brawl_points) - score
